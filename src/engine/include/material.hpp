...
public:
    ...
    int diffuse_texture_flag = 0;
    int normal_texture_flag = 0;
    int specular_texture_flag = 0;
    int reflection_texture_flag = 0;
    ...
    void get_texture(aiMaterial *amtl, aiTextureType texture_type, Texture *&texture, int &texture_flag);
};
