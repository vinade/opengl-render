...
def create_model(inputShape):
    ...
    QUART_FILTERS = 8
    HALF_FILTERS = QUART_FILTERS * 2  # 16
    FILTERS = HALF_FILTERS * 2  # 32
    DOUBLE_FILTERS = FILTERS * 2  # 64
    TETRA_FILTERS = DOUBLE_FILTERS * 2  # 128
    OCT_FILTERS = TETRA_FILTERS * 2  # 256
    KERNEL_SIZE_1 = (1, 1)
    KERNEL_SIZE_3 = (3, 3)
    KERNEL_SIZE_5 = (5, 5)
    KERNEL_SIZE_7 = (7, 7)
    ...
    # model.add(Conv2D(FILTERS, KERNEL_SIZE_7, padding="same"))
    model.add(Conv2D(QUART_FILTERS, KERNEL_SIZE_3, padding="same"))
    # model.add(Conv2D(FILTERS, KERNEL_SIZE_11, padding="same"))
    model.add(Conv2D(FILTERS, KERNEL_SIZE_7,
    ...
    model.add(Conv2D(TETRA_FILTERS, KERNEL_SIZE_5,
    ...
    # model.add(Activation("relu"))
    model.add(Activation("relu"))
    # model.add(Conv2D(TETRA_FILTERS, KERNEL_SIZE_5, padding="same"))
    # model.add(Conv2D(TETRA_FILTERS, KERNEL_SIZE_5, padding="same"))
    # model.add(Activation("relu"))
    ...
    model.add(Conv2D(1, KERNEL_SIZE_3, padding="same"))
...
# training_schedule = []
training_schedule = [100, 70, 50, 30, 20, 10, 9, 8, 7, 6, 5, 4, 3, 2]
