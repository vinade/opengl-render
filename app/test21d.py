...
def create_model(inputShape):
    ...
    model.add(DepthwiseConv2D(KERNEL_SIZE_3, depth_multiplier=3))
    model.add(Activation("relu"))
    model.add(DepthwiseConv2D(KERNEL_SIZE_3,
                              strides=(2, 2), depth_multiplier=1))
    model.add(Activation("relu"))
    model.add(DepthwiseConv2D(KERNEL_SIZE_9, depth_multiplier=10))
    model.add(Activation("relu"))
    model.add(DepthwiseConv2D(KERNEL_SIZE_9, depth_multiplier=1))
    model.add(Activation("relu"))

    # model.add(DepthwiseConv2D(KERNEL_SIZE_3, depth_multiplier=1))
    # model.add(Activation("relu"))
    # model.add(DepthwiseConv2D(KERNEL_SIZE_3, depth_multiplier=1))
    # model.add(Activation("relu"))
    # model.add(DepthwiseConv2D(KERNEL_SIZE_7,
    #                           strides=(2, 2), depth_multiplier=1))
    # model.add(Activation("relu"))
    # model.add(DepthwiseConv2D(KERNEL_SIZE_7, depth_multiplier=2))
    # model.add(Activation("relu"))
    # model.add(DepthwiseConv2D(KERNEL_SIZE_7, depth_multiplier=2))
    # model.add(Activation("relu"))
...
data_loader = DepthDataLoader(IMAGES_N, (140, 100))
