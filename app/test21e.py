...
def create_model(inputShape):
    ...
    model.add(DepthwiseConv2D(KERNEL_SIZE_3,
                              strides=(2, 2), depth_multiplier=4))
    model.add(Activation("relu"))
    model.add(DepthwiseConv2D(KERNEL_SIZE_3,
                              strides=(2, 2), depth_multiplier=30))
    model.add(Activation("relu"))
    model.add(DepthwiseConv2D(KERNEL_SIZE_5, depth_multiplier=1))
    model.add(Activation("relu"))
    model.add(DepthwiseConv2D(KERNEL_SIZE_5, depth_multiplier=1))
    model.add(Activation("relu"))
...
data_loader = DepthDataLoader(IMAGES_N, (69, 49))
