...
def create_model(inputShape):
    ...
    model.add(DepthwiseConv2D(KERNEL_SIZE_3, depth_multiplier=20))
    model.add(Conv2D(FILTERS, KERNEL_SIZE_1))

    model.add(Conv2D(FILTERS, KERNEL_SIZE_3))
...
data_loader = DepthDataLoader(IMAGES_N, (126, 86))
