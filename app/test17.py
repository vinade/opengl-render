...
def create_model(inputShape):
    ...
    model.add(Conv2D(FILTERS, KERNEL_SIZE_7, strides=(2, 2), padding="same"))
    ...
    # model.add(Conv2D(OCT_FILTERS, KERNEL_SIZE_5, padding="same"))
    # model.add(BatchNormalization())
    # model.add(Activation("relu"))
    model.add(Conv2D(HEX_FILTERS, KERNEL_SIZE_3, padding="same"))
    model.add(BatchNormalization())
    model.add(Activation("relu"))
    model.add(Conv2D(OCT_FILTERS, KERNEL_SIZE_3, padding="same"))
    model.add(Activation("relu"))
